...
namespace PotterShoppingCart.Test
{
    ...
    public class ShoppingCartTest
    {
        ...
        [TestMethod]
        public void Test_一次買整套一二三四五集各買一本_價格應為375()
        {
            //arrange
            var target = new ShoppingCart();
            var products = new List<Product>()
            {
                ...
                new Product{ ProductId=3,ProductName="哈利波特第三集",Price=100},
                new Product{ ProductId=4,ProductName="哈利波特第四集",Price=100},
                new Product{ ProductId=5,ProductName="哈利波特第五集",Price=100}
            };
            target.AddProducts(products);
        ...
        [TestMethod]
        public void Test_一二集各買一本_第三集買兩本_價格應為370()
        {
            //arrange
            var target = new ShoppingCart();
            var products = new List<Product>()
         ...
         [TestMethod]
        public void Test_第一集買一本_第二三集各買兩本_價格應為460()
        {
            //arrange
            var target = new ShoppingCart();
            var products = new List<Product>()
